...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .rp-success-title { font-weight: 500; color: #4ade80; margin-bottom: 0.4rem; }
  .rp-success-desc { font-size: 0.85rem; color: rgba(74,222,128,0.65); }
    ...
    <>
      ...
      <div className="rp-root">
        <div className="rp-card">
          <Link to="/" className="rp-logo">Luxe Store</Link>
          <div className="rp-icon">🔑</div>
          <h1 className="rp-title">Set new password</h1>
          <p className="rp-desc">Choose a strong password for your account.</p>
          ...
          {success ? (
            <div className="rp-success">
              ...
              <div className="rp-success-desc">Redirecting you to login...</div>
            </div>
          ) : (
