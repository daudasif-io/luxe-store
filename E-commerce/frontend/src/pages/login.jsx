      ...
      <div className="auth-root">
        ...
        <div className="auth-left">
          ...
          <div className="auth-left-content">
            <h2 className="auth-left-title">Welcome<br />back to<br /><em>Luxe.</em></h2>
            <p className="auth-left-desc">Sign in to continue shopping curated premium products selected just for you.</p>
          </div>
